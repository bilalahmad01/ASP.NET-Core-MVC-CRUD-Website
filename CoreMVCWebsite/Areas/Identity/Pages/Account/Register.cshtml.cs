...
namespace CoreMVCWebsite.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)      // CallOnRegisterPageLoad
        {
        ...
        private ApplicationUser CreateUser()
        {
            try
            {
                ...
                return Activator.CreateInstance<ApplicationUser>();  // For adding new columns we will use ApplicationUser
            }
            catch
            {
